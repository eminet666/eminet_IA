...
def generate_italian_dialogue():
    ...
    # Liste de sujets italiens
    sujets = [
        " Un apéritif entre amis ", " Au marché local ", " Une excursion à Rome ",
        " Le cinéma italien ", " Une discussion sur le football ", " Les vacances d'été ",
        " La cuisine régionale italienne ", " Un entretien d'embauche ", " Les transports à Milan ",
        " Une visite à Venise ", " La mode italienne ", " La Renaissance ",
        " Un dîner en famille ", " Les vins italiens ", " Dante et la littérature italienne ",
        " Les fêtes traditionnelles italiennes ", " Le sport en Italie ", " Un voyage en Sicile ",
        " La musique italienne contemporaine ", " Le système scolaire italien ",
        " Un problème avec le voisin ", " Les traditions napolitaines ", " L'art baroque italien ",
        " Une conversation romantique ", " Les musées de Florence ", " La commedia dell'arte ",
        " Un week-end en Toscane ", " Le café italien et sa culture ",
        " Une discussion sur la politique italienne ", " Le design italien ",
        " Une visite aux Offices ", " L'histoire de l'Empire romain ",
        " Les îles italiennes ", " La Sardaigne ", " Le carnaval de Venise ",
        " La pizza napolitaine ", " Un voyage en train à travers l'Italie ",
        " Une soirée à l'opéra ", " Les sports d'hiver en Italie ",
        " La philosophie italienne de la Renaissance ", " Une dispute amicale entre collègues ",
        " Les traditions de Noël en Italie ", " Une rencontre inattendue ",
        " La vie nocturne italienne ", " Un rendez-vous romantique à Vérone "
    ]
...
def extract_dialogue_lines(html_content):
    ...
    pattern = r'<p><strong>(Marco|Sofia):</strong>\s*(.*?)</p>'
    ...
    for speaker, text in matches:
        ...
        speaker_normalized = "Marco" if "Marco" in speaker else "Sofia"
...
async def generate_audio_from_dialogue_async(dialogue_lines, output_file="dialogue.mp3"):
    ...
    avec edge-tts pour des voix italiennes naturelles
    """
...
def generate_pdf_from_dialogue(html_content, title=None, output_file="dialogue_italien.pdf"):
    """
    ...
    # Titre du document
    pdf_title = title if title else "Dialogue en italien"
...
def send_email(content, audio_file=None, pdf_file=None, title=None):
    ...
    recipients = ["eminet666@gmail.com"]
...
if __name__ == "__main__":
    # Générer le dialogue
    dialogue = generate_italian_dialogue()
    ...
    audio_file = None
    if dialogue_lines:
        audio_file = generate_audio_from_dialogue(dialogue_lines, "dialogue_italien.mp3")
    
    # Générer le fichier PDF
    pdf_file = generate_pdf_from_dialogue(dialogue, title, "dialogue_italien.pdf")
