...
def generate_pdf_from_dialogue(html_content, title=None, output_file="dialogue_anglais.pdf"):
    """
    Génère un fichier PDF stylisé à partir du dialogue HTML
    """
    print(f"- Génération du PDF...")

    pdf_title = title if title else "English Dialogue"
    ...
    <head>
        ...
        <style>
            ...
            .header {{ text-align: center; margin-bottom: 15px; padding-bottom: 10px; border-bottom: 2px solid {ACCENT_COLOR}; }}
            ...
            .vocab-table th {{ background-color: {ACCENT_COLOR}; color: white; padding: 4px; text-align: left; font-weight: bold; font-size: 11pt; }}
