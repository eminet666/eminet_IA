# main.py
# Script principal de l'agent d'apprentissage de l'italien
...
from dialogue_generator import generate_italian_dialogue, extract_title, extract_dialogue_lines
...
def main():
    ...
    dialogue = generate_italian_dialogue(client)
