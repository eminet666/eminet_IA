# main.py
# Script principal de l'agent d'apprentissage de l'espagnol
...
from dialogue_generator import generate_spanish_dialogue, extract_title, extract_dialogue_lines
...
def main():
    ...
    dialogue = generate_spanish_dialogue(client)
    ...
    audio_file = None
    if dialogue_lines:
        audio_file = generate_audio_from_dialogue(dialogue_lines, "dialogue_espagnol.mp3")

    # Générer le fichier PDF
    pdf_file = generate_pdf_from_dialogue(dialogue, title, "dialogue_espagnol.pdf")
